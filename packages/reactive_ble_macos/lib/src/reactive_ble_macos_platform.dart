...
class ReactiveBleMacosPlatform extends ReactiveBlePlatform {
  ReactiveBleMacosPlatform({
...
class ReactiveBleMacosPlatformFactory {
  const ReactiveBleMacosPlatformFactory();

  ReactiveBleMacosPlatform create() {
    ...
    return ReactiveBleMacosPlatform(

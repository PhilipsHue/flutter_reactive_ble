...
data class ConnectionUpdateSuccess(val deviceId: String, val connectionState: Int) :
    ConnectionUpdate()

data class ConnectionUpdateError(val deviceId: String, val errorMessage: String) :
    ConnectionUpdate()
...
data class EstablishedConnection(val deviceId: String, val rxConnection: RxBleConnection) :
    EstablishConnectionResult()

data class EstablishConnectionFailure(val deviceId: String, val errorMessage: String) :
    EstablishConnectionResult()
...
data class CharOperationSuccessful(val deviceId: String, val value: List<Byte>) :
    CharOperationResult()

data class CharOperationFailed(val deviceId: String, val errorMessage: String) :
    CharOperationResult()

sealed class RequestConnectionPriorityResult
data class RequestConnectionPrioritySuccess(val deviceId: String) :
    RequestConnectionPriorityResult()

data class RequestConnectionPriorityFailed(val deviceId: String, val errorMessage: String) :
    RequestConnectionPriorityResult()

...
class DeviceScanInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceScanInfo', createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rawData', $pb.PbFieldType.OY, protoName: 'rawData')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $core.List<$core.int> get rawData => $_getN(7);
  @$pb.TagNumber(8)
  set rawData($core.List<$core.int> v) { $_setBytes(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasRawData() => $_has(7);
  @$pb.TagNumber(8)
  void clearRawData() => clearField(8);
}

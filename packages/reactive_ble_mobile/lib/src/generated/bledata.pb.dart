...
class WriteDescriptorInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WriteDescriptorInfo', createEmptyInstance: create)
    ..aOM<DescriptorAddress>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'descriptor', subBuilder: DescriptorAddress.create)
    ..aOM<GenericFailure>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failure', subBuilder: GenericFailure.create)
    ..hasRequiredFields = false
  ;

  WriteDescriptorInfo._() : super();
  factory WriteDescriptorInfo({
    DescriptorAddress? descriptor,
    GenericFailure? failure,
  }) {
    final _result = create();
  ...
  factory WriteDescriptorInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WriteDescriptorInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  WriteDescriptorInfo clone() => WriteDescriptorInfo()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WriteDescriptorInfo copyWith(void Function(WriteDescriptorInfo) updates) => super.copyWith((message) => updates(message as WriteDescriptorInfo)) as WriteDescriptorInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static WriteDescriptorInfo create() => WriteDescriptorInfo._();
  WriteDescriptorInfo createEmptyInstance() => create();
  static $pb.PbList<WriteDescriptorInfo> createRepeated() => $pb.PbList<WriteDescriptorInfo>();
  @$core.pragma('dart2js:noInline')
  static WriteDescriptorInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WriteDescriptorInfo>(create);
  static WriteDescriptorInfo? _defaultInstance;
...
class DescriptorAddress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DescriptorAddress', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceId', protoName: 'deviceId')
    ..aOM<Uuid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceUuid', protoName: 'serviceUuid', subBuilder: Uuid.create)
    ..aOM<Uuid>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'characteristicUuid', protoName: 'characteristicUuid', subBuilder: Uuid.create)
    ..aOM<Uuid>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'descriptorUuid', protoName: 'descriptorUuid', subBuilder: Uuid.create)
    ..hasRequiredFields = false
  ;

  DescriptorAddress._() : super();
  factory DescriptorAddress({
    $core.String? deviceId,
    Uuid? serviceUuid,
    Uuid? characteristicUuid,
    Uuid? descriptorUuid,
  ...
  factory DescriptorAddress.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DescriptorAddress.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DescriptorAddress clone() => DescriptorAddress()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DescriptorAddress copyWith(void Function(DescriptorAddress) updates) => super.copyWith((message) => updates(message as DescriptorAddress)) as DescriptorAddress; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DescriptorAddress create() => DescriptorAddress._();
  DescriptorAddress createEmptyInstance() => create();
  static $pb.PbList<DescriptorAddress> createRepeated() => $pb.PbList<DescriptorAddress>();
  @$core.pragma('dart2js:noInline')
  static DescriptorAddress getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DescriptorAddress>(create);
  static DescriptorAddress? _defaultInstance;
  ...
  @$pb.TagNumber(4)
  Uuid get descriptorUuid => $_getN(3);
  @$pb.TagNumber(4)
  set descriptorUuid(Uuid v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDescriptorUuid() => $_has(3);
  @$pb.TagNumber(4)
  void clearDescriptorUuid() => clearField(4);
  @$pb.TagNumber(4)
  Uuid ensureDescriptorUuid() => $_ensure(3);
}

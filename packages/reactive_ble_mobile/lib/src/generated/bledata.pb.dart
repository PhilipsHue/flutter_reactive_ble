...
class DiscoveredService extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DiscoveredService', createEmptyInstance: create)
    ...
    ..pc<DiscoveredCharacteristic>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'characteristics', $pb.PbFieldType.PM, subBuilder: DiscoveredCharacteristic.create)
    ..hasRequiredFields = false
  ;
...
class DiscoveredCharacteristic extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DiscoveredCharacteristic', createEmptyInstance: create)
    ...
    ..aOM<Uuid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceId', protoName: 'serviceId', subBuilder: Uuid.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isReadable', protoName: 'isReadable')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isWritableWithResponse', protoName: 'isWritableWithResponse')
...
class ConnectedDevicesInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConnectedDevicesInfo', createEmptyInstance: create)
    ..pc<ConnectedDevice>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connectedDevices', $pb.PbFieldType.PM, protoName: 'connectedDevices', subBuilder: ConnectedDevice.create)
    ..aOM<GenericFailure>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failure', subBuilder: GenericFailure.create)
    ..hasRequiredFields = false
  ;

  ConnectedDevicesInfo._() : super();
  factory ConnectedDevicesInfo({
    $core.Iterable<ConnectedDevice>? connectedDevices,
    GenericFailure? failure,
  }) {
    final _result = create();
    if (connectedDevices != null) {
      _result.connectedDevices.addAll(connectedDevices);
    }
    if (failure != null) {
      _result.failure = failure;
    }
  ...
  factory ConnectedDevicesInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ConnectedDevicesInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ConnectedDevicesInfo clone() => ConnectedDevicesInfo()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConnectedDevicesInfo copyWith(void Function(ConnectedDevicesInfo) updates) => super.copyWith((message) => updates(message as ConnectedDevicesInfo)) as ConnectedDevicesInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ConnectedDevicesInfo create() => ConnectedDevicesInfo._();
  ConnectedDevicesInfo createEmptyInstance() => create();
  static $pb.PbList<ConnectedDevicesInfo> createRepeated() => $pb.PbList<ConnectedDevicesInfo>();
  @$core.pragma('dart2js:noInline')
  static ConnectedDevicesInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ConnectedDevicesInfo>(create);
  static ConnectedDevicesInfo? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<ConnectedDevice> get connectedDevices => $_getList(0);
...
class ConnectedDevice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConnectedDevice', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceId', protoName: 'deviceId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceName', protoName: 'deviceName')
    ..hasRequiredFields = false
  ;

  ConnectedDevice._() : super();
  ...
  factory ConnectedDevice.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ConnectedDevice.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ConnectedDevice clone() => ConnectedDevice()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConnectedDevice copyWith(void Function(ConnectedDevice) updates) => super.copyWith((message) => updates(message as ConnectedDevice)) as ConnectedDevice; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ConnectedDevice create() => ConnectedDevice._();
  ConnectedDevice createEmptyInstance() => create();
  static $pb.PbList<ConnectedDevice> createRepeated() => $pb.PbList<ConnectedDevice>();
  @$core.pragma('dart2js:noInline')
  static ConnectedDevice getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ConnectedDevice>(create);
  static ConnectedDevice? _defaultInstance;

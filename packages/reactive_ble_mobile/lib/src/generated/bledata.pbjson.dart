...
const DeviceScanInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'isConnectable', '3': 8, '4': 1, '5': 11, '6': '.IsConnectable', '10': 'isConnectable'},
  ],
};

/// Descriptor for `DeviceScanInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deviceScanInfoDescriptor = $convert.base64Decode('');
...
const CharacteristicAddress$json = const {
  ...
  '2': const [
    ...
    const {'1': 'serviceInstanceId', '3': 4, '4': 1, '5': 9, '10': 'serviceInstanceId'},
    const {'1': 'characteristicInstanceId', '3': 5, '4': 1, '5': 9, '10': 'characteristicInstanceId'},
  ],
};
...
const DiscoveredService$json = const {
  ...
  '2': const [
    ...
    const {'1': 'serviceInstanceId', '3': 5, '4': 1, '5': 9, '10': 'serviceInstanceId'},
  ],
};

/// Descriptor for `DiscoveredService`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List discoveredServiceDescriptor = $convert.base64Decode('');
...
const DiscoveredCharacteristic$json = const {
  ...
  '2': const [
    ...
    const {'1': 'characteristicInstanceId', '3': 8, '4': 1, '5': 9, '10': 'characteristicInstanceId'},
  ],
};
...
final $typed_data.Uint8List isConnectableDescriptor = $convert.base64Decode('Cg1Jc0Nvbm5lY3RhYmxlEhIKBGNvZGUYASABKAVSBGNvZGU=');
